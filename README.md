...
- Command: `sudo ./demo -D 9 --led-rows=64 --led-cols=64 --led-gpio-mapping=adafruit-hat-pwm --led-chain=4 --led-slowdown-gpio=2 --led-pixel-mapper="U-mapper;Rotate:180;Mirror:H"`
